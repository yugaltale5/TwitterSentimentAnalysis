...
label_1 = Label(root, text = "Enter the word you want to analyse", font = ("Arial Black", 15, "bold"),bg="black", fg = "red").place(x = 90, y = 300)
label_2 = Label(root,text="Note:- It might take some time for the result to be displayed.",font=("Comic Sans MS",20,"italic"),fg='yellow',bg ='black').place(x=145,y=550)
